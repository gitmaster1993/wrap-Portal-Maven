...
public class Niyati_Test_1427 extends BaseClass {
	...
	@Test
	public void ReadPDFCOI_1427() throws Throwable {
		...
		test.log(LogStatus.PASS, "Set Up General certificates is clicked");
		Thread.sleep(2000);
		wb.SwitchtoChild2();
		wb.getTitle();
		wb.selectByVisibleText(Insured, AddContractor_Pkg_MonthlyPayroll_Page.Select_Insured_String(driver));
		test.log(LogStatus.PASS, "Set Up General certificates is clicked as Insured");
		js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
		Thread.sleep(3000);
		wb.click(AddContractor_Pkg_MonthlyPayroll_Page.SaveandClose_InsuCert(driver));
		test.log(LogStatus.PASS, "save and close  is clicked as Insured");
		Thread.sleep(3000);
		wb.Switchtoparent();
		...
		test.log(LogStatus.PASS, "Hyper text validated and clicked on Hireracy button");
		...
		test.log(LogStatus.PASS, "COI Payroll is validated at frame by status list ");
		wb.SwitchtonewTab();
		Thread.sleep(4000);
		js.executeScript("window.scrollTo(0,0)");
		Thread.sleep(2000);
		...
		System.out.println(driver.getWindowHandles() + driver.getTitle());
		...
		wb.Switchtoparent();
		test.log(LogStatus.PASS, test.addScreenCapture(FileUtils1.captureScreen(driver, "1427")));
	}
}
