...
public class NodeAdmin_Edit__Validations_Test extends BaseClass{
	...
	public  void Edit_Validations() throws Throwable {
		...
		wb.UN_Tick_List_of_ChkBoxes(SecurityGroupsModule.Edit_list_CheckBoxes(driver));
//		SecurityGroupsModule.EditModule_Chk_Box().click();
//		SecurityGroupsModule.EditModule_Chk_Box().click();
			...
			if (list.equals(list1.size())) {
				...
				if (list.equals(list1.size())) {
					...
					if (list.equals(list1.size())) {
						...
						wb.Tick_List_of_ChkBoxes(SecurityGroupsModule.Edit_list_CheckBoxes(driver));
						//SecurityGroupsModule.EditModule_Chk_Box().click();
						test.log(LogStatus.PASS, "Add Icon Chk bok  is clicked succesfully");
						wb.scrollToEndt();
						Thread.sleep(3000);
		...
		test.log(LogStatus.PASS, test.addScreenCapture(FileUtils1.captureScreen(driver, "NodeAdmin_Edit__Validations_Test")));
	}
}
