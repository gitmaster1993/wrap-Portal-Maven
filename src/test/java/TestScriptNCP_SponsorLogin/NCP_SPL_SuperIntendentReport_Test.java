...
public class NCP_SPL_SuperIntendentReport_Test extends BaseClass {
	...
	public void testEnrollmentStatusReport(String ProgramName, String Division, String Projects) throws Throwable {
		...
		try {
			...
			wb.selectSingleValueFromList(Report_SuperIntendentReport.SelectDivisionFromList(driver), Division);
			test.log(LogStatus.PASS, Division + " Divisions Selected Successfully");
			wb.selectSingleValueFromList(Report_SuperIntendentReport.SelectProjectFromList(driver), Projects);
			...
			test.log(LogStatus.PASS, " Contractor Selected Successfully" + "All Contractors");
