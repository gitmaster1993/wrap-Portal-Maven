...
public class Report_NCP_Contractor_Cost_Summary_Test extends  BaseClass
{
	
	WebDriverCommonLib wb = new WebDriverCommonLib();
	public String reportName = "Contractor Cost Summary";

	@Test(dataProvider = "excelData")
	public void testContractorCostSummaryReport(String ProgramName, String Division, String Projects)
			throws Throwable {
...
//		wb.selectSingleValueByIndex(Report_NCP_Contractor_Cost_Summary.selectProgram(driver), 1);
		...
		try {
			...
			Assert.assertEquals(Report_NCP_Contractor_Cost_Summary.reportHeader(driver).getText(),
					"Contractor Cost Summary Report");
