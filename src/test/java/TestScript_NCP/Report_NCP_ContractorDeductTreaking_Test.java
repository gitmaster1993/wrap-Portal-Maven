...
import ObjectRepository_NCP.Report_NCP_ContractorDeduct_Tracking;

public class Report_NCP_ContractorDeductTreaking_Test extends BaseClass {
	...
	public void testContractorDeductTrackingReport(String ProgramName, String Division, String Projects)
		...
		Thread.sleep(1000);
//		wb.selectSingleValueByIndex(Report_NCP_ContractorDeduct_Tracking.selectProgram(driver), 1);
		test.log(LogStatus.PASS, Projects + " Project Selected");
		Thread.sleep(1000);
		wb.selectSingleValue(Report_NCP_ContractorDeduct_Tracking.selectContractor(driver), "All Contractors");
		test.log(LogStatus.PASS, " Contractor Selected");
		Report_NCP_ContractorDeduct_Tracking.btnBuildReport(driver).click();
		...
		try {
			...
			Thread.sleep(2000);
			System.out.println(Report_NCP_ContractorDeduct_Tracking.reportHeader(driver).getText());
			Assert.assertEquals(Report_NCP_ContractorDeduct_Tracking.reportHeader(driver).getText(),
					"Contractor Deduct Tracking Report");
