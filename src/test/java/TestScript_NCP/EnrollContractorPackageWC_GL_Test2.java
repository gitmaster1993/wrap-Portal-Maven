...
public class EnrollContractorPackageWC_GL_Test2 extends BaseClass
{
...
//		wb.printListData(AddContractor_Pkg_Page.selectTradeDropdownAutocomplete(driver));
		 ...
		 * System.out.println("Trade Alert Not Present"+e); x=2; } } while (x==1)
		 */;
...
//		System.out.println(dba);
		 ...
		 * " Clicked On Select Program Field"); Thread.sleep(2000);
		 ...
		 * tradeNumber); test.log(LogStatus.PASS,
		 * tradeNumber+" Trade successfully selected form drop down");
		 * Thread.sleep(2500);
		 * 
		 * 
		 * 
...
/*	@Test(dependsOnMethods={"enrollCPWC_GL"})
	public void testConfirmCP_AddPayroll()
	{
