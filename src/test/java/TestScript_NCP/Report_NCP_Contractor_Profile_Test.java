...
import ObjectRepository_NCP.Report_NCP_Contractor_Profile;

public class Report_NCP_Contractor_Profile_Test extends BaseClass {
	...
	public void testMissing_PayrollBy_Contractor_Report(String ProgramName, String Division, String Projects)
		...
		Thread.sleep(1000);
		// wb.selectSingleValueByIndex(Report_NCP_Contractor_Profile.selectProgram(driver),
		// 1);
		test.log(LogStatus.PASS, Projects + " Project Selected");
		Thread.sleep(1000);
		wb.selectSingleValue(Report_NCP_Contractor_Profile.selectContractor(driver), "All Contractors");
		test.log(LogStatus.PASS, " Contractor Selected");

		Report_NCP_Contractor_Profile.btnBuildReport(driver).click();
		...
		try {
			...
			Thread.sleep(2000);
			System.out.println(Report_NCP_Contractor_Profile.reportHeader(driver).getText());
			Assert.assertEquals(Report_NCP_Contractor_Profile.reportHeader(driver).getText(), "Contractor Profile");
