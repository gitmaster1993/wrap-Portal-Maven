...
import ObjectRepository.Report_SubcontractorStatusReportOld;

public class Report_SubcontractorStatusReportOld_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Subcontractor Status";

	@Test(dataProvider = "excelData")
	public void testSubcontractorStatusReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_SubcontractorStatusReportOld.selectReport(driver, selectReportName).click();
			...
			/*
			 * wb.selectSingleValue(Report_SubcontractorStatusReportOld.
			 * selectDivision(driver), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */

			// wb.selectSingleValueByIndex(Report_SubcontractorStatusReportOld.selectProjects(driver),
			// 1);

			wb.selectSingleValue(Report_SubcontractorStatusReportOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);

			Thread.sleep(3000);
			Report_SubcontractorStatusReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_SubcontractorStatusReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_SubcontractorStatusReportOld.reportHeaderReportName(driver).getText(),
