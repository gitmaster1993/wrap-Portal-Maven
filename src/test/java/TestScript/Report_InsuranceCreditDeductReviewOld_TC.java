...
public class Report_InsuranceCreditDeductReviewOld_TC extends BaseClass 
{
	...
	public void testInsuranceCreditDeductReviewOld(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2)
		...
		try {
			...
			wb.selectSingleValueByIndex(Report_InsuranceCreditDeductReviewOld.selectProjects(driver), 0);
...
//			driver.switchTo().defaultContent();
		...
		Report_InsuranceCreditDeductReviewOld.linkExportToPDF(driver).click();
		wb.getWindowID3();
		...
		Report_InsuranceCreditDeductReviewOld.linkExportToExcel(driver).click();
		Thread.sleep(10000);
