...
public class Report_ContractorDeductSummaryTC extends BaseClass {
...
//	String project2 = "712 West Peachtree";
	...
	public void testContractorDeductSummary(String ProgramName, String Division, String Projects, String userName,
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			//Raja-by default it is selected 
			/*
			 * js.executeScript("arguments[0].scrollIntoView();",
			 * Report_ContractorDeductSummary.filterSelectDivisionDropdown(driver));
			 * wb.selectSingleValue(Report_ContractorDeductSummary.
			 * filterSelectDivisionDropdown(driver), Division); test.log(LogStatus.PASS,
			 * Division + "  Selected Successfully");
			 * 
			 * js.executeScript("arguments[0].scrollIntoView();",
			 * Report_ContractorDeductSummary.filterSelectProjectFormOption(driver,
			 * Projects));
			 * Report_ContractorDeductSummary.filterSelectProjectFormOption(driver,
			...
			js.executeScript("arguments[0].scrollIntoView();",Report_ContractorDeductSummary.btnBuildReport(driver));
		...
		// filter testing
		Report_ContractorDeductSummary.filterWindowButton(driver).click();
		Thread.sleep(3000);
		Report_ContractorDeductSummary.filterSelectProjectFormOption(driver, ProjectNAME1).click();
		...
		Report_ContractorDeductSummary.filterWindowButton(driver).click();
		Thread.sleep(3000);
		Report_ContractorDeductSummary.filterSelectProjectFormOption(driver, ProjectNAME2).click();
		...
		// Excel file
		Report_ContractorDeductSummary.excelLink(driver).click();
		...
		if (wb.isFileDownloaded("Contractor_Deduct_Summary.xls") == true) {
		...
		Thread.sleep(3000);
		Report_ContractorDeductSummary.addFilterBtnOutside(driver).click();
		test.log(LogStatus.PASS, "Clicked on Add Filter Button From Filter");
		wb.getWindowID3();
		driver.switchTo().window(wb.map.get("subchildID"));
		driver.manage().window().maximize();
		wb.waitForElemnet(Report_ContractorDeductSummary.selectAnFilterDropdown(driver));
		wb.selectSingleValueByIndex(Report_ContractorDeductSummary.selectAnFilterDropdown(driver), 1);
		Thread.sleep(3000);
		test.log(LogStatus.PASS, " Filter Selected Successfully From Dropdown");
		wb.selectSingleValueByIndex(Report_ContractorDeductSummary.selectAFilterCondition(driver), 1);
		Thread.sleep(3000);
		test.log(LogStatus.PASS, "Filter Condition Selected Successfully ");
		Report_ContractorDeductSummary.addFilterParameter1(driver).click();
		Thread.sleep(1000);
		wb.selectSingleValueFromList(Report_ContractorDeductSummary.selectParameter1(driver), "Enrolled");
		test.log(LogStatus.PASS, "Parameter Selected Successfully ");
		Report_ContractorDeductSummary.addFilterBtnInside(driver).click();
	...
	public void testCount(int contPkgSize) {
		...
		List<WebElement> countOfContractorPkg = Report_ContractorDeductSummary.countContractorPkg(driver);
