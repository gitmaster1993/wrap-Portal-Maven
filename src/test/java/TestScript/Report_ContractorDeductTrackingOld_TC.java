...
import ObjectRepository.Report_ContractorDeductTrackingOld;
import ObjectRepository.Report_EnrollmentListReportOld;

public class Report_ContractorDeductTrackingOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Contractor Deduct Tracking";

	@Test(dataProvider = "excelData")
	public void testContractorDeductTrackingOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ContractorDeductTrackingOld.selectReport(driver, selectReportName).click();
			...
			/*
			 * wb.selectSingleValue(Report_ContractorDeductTrackingOld.
			 * selectDivision(driver), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */

			// wb.selectSingleValueByIndex(Report_ContractorDeductTrackingOld.selectProjects(driver),
			// 1);
			// test.log(LogStatus.PASS, " Project Selected Successfully");
			// Thread.sleep(3000);

			wb.selectSingleValue(Report_ContractorDeductTrackingOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);

			wb.selectSingleValue(Report_ContractorDeductTrackingOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_ContractorDeductTrackingOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_ContractorDeductTrackingOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ContractorDeductTrackingOld.reportHeaderReportName(driver).getText(),
					"Contractor Deduct Tracking");
