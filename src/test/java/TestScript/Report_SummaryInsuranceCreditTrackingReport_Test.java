...
public class Report_SummaryInsuranceCreditTrackingReport_Test extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Summary Insurance Credit Tracking Report";
	String reportNameHeader = "Summary Insurance Credit Tracking Report";
	...
	public void testProjectSpecificReport(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			/*
			 * wb.selectSingleValue(ReportModule.filterSelectDivisionDropdown(
			 * driver), Division); test.log(LogStatus.PASS, Division +
			 * " Divisions Selected Successfully");
			 */
			ReportModule.filterSelectProjectFormOption(driver, "All Worksites").click();
		...
		// Filter Testing
		/*
		 * ReportModule.FilterWindowButton(driver).click(); Thread.sleep(3000);
		 * 
		 * JavascriptExecutor js = (JavascriptExecutor) driver; // select first
		 * project js.executeScript("arguments[0].click();",
		 * ReportModule.filterSelectProjectFormOption(driver,
		 * "Test Project 10")); Thread.sleep(1000); // select 2nd Project
		 ...
		 * // 10").click(); test.log(LogStatus.PASS,
		 * " Project Selected Successfully");
		 * 
		 * wb.selectSingleValue(Report_GL_Credit_Tracking_Report.
		 * filterSelectContractorFormOption(driver), "All Contractors");
		 * test.log(LogStatus.PASS, " Contractor Selected Successfully");
		 * 
		 * ReportModule.btnBuildReport(driver).click(); test.log(LogStatus.INFO,
		 * " Clicked On Build Report Button"); Thread.sleep(5000);
		 */
