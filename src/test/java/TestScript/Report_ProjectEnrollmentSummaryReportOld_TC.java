...
public class Report_ProjectEnrollmentSummaryReportOld_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Project Enrollment Summary";

	@Test(dataProvider = "excelData")
	public void testProjectSummaryReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ProjectSummaryReportOld.selectProjects(driver), "All Worksites");
