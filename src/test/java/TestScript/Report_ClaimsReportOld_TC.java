...
import ObjectRepository.Report_ClaimsReportOld;
import ObjectRepository.Report_EnrollmentListReportOld;

public class Report_ClaimsReportOld_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Claims Report";

	@Test(dataProvider = "excelData")
	public void testClaimsReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ClaimsReportOld.selectReport(driver, selectReportName).click();
			...
			/*
			 * wb.selectSingleValue(Report_ClaimsReportOld.selectDivision(driver
			 * ), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */

			// wb.selectSingleValueByIndex(Report_ClaimsReportOld.selectProjects(driver),
			// 1);

			wb.selectSingleValue(Report_ClaimsReportOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ClaimsReportOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_ClaimsReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_ClaimsReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ClaimsReportOld.reportHeaderReportName(driver).getText(), "Claims Report");
