...
public class Report_EnrollmentListReportOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Enrollment List Report";

	@Test(dataProvider = "excelData")
	public void testEnrollmentListReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			// wb.selectSingleValue(Report_EnrollmentListReportOld.selectDivision(driver),Division);
			// test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_EnrollmentListReportOld.selectProjects(driver), Projects);
			...
			Thread.sleep(3000);
			Report_EnrollmentListReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_EnrollmentListReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_EnrollmentListReportOld.reportHeaderReportName(driver).getText(),
					"Enrollment List");
