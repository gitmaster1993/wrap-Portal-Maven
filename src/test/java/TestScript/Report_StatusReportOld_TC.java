...
import ObjectRepository.Report_StatusReportOld;

public class Report_StatusReportOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Status Report";

	@Test(dataProvider = "excelData")
	public void testStatusReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_StatusReportOld.selectReport(driver, selectReportName).click();
			...
			/*
			 * wb.selectSingleValue(Report_StatusReportOld.selectDivision(driver
			 * ), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */

			// wb.selectSingleValueByIndex(Report_StatusReportOld.selectProjects(driver),
			// 1);

			wb.selectSingleValue(Report_StatusReportOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);

			wb.selectSingleValue(Report_StatusReportOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_StatusReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_StatusReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_StatusReportOld.reportHeaderReportName(driver).getText(), "Status Report");
