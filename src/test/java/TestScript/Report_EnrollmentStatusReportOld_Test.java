...
public class Report_EnrollmentStatusReportOld_Test extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Enrollment Status";

	@Test(dataProvider = "excelData")
	public void testEnrollmentStatusReportOld(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2)
		...
		try {
			...
			wb.selectSingleValueByIndex(Report_ContractorCloseOutTrackingOld.selectProjects(driver), 1);
			test.log(LogStatus.PASS, " Project Selected Successfully");

			/*
			 * wb.selectSingleValue(Report_ContractorCloseOutTrackingOld.
			 * selectProjects(driver), Projects); test.log(LogStatus.PASS,
			 * " Project Selected Successfully");
			 */
			Thread.sleep(3000);
			wb.selectSingleValueByIndex(Report_ContractorCloseOutTrackingOld.selectContractors(driver), 2);
		...
		try {
			...
			System.out.println(Report_ContractorCloseOutTrackingOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ContractorCloseOutTrackingOld.reportHeaderReportName(driver).getText(),
					"Enrollment Status");
