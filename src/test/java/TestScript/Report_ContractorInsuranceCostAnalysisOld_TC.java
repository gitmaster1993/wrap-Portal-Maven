...
import ObjectRepository.Report_ContractorInsuranceCostAnalysisOld;
import ObjectRepository.Report_EnrollmentListReportOld;

public class Report_ContractorInsuranceCostAnalysisOld_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Contractor Insurance Cost Analysis";

	@Test(dataProvider = "excelData")
	public void testContractorInsuranceCostAnalysisOld(String ProgramName, String Division, String Projects,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ContractorInsuranceCostAnalysisOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			wb.selectSingleValue(Report_ContractorInsuranceCostAnalysisOld.selectDivision(driver), "All Divisions");
			test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ContractorInsuranceCostAnalysisOld.selectProjects(driver), "All Projects");
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ContractorInsuranceCostAnalysisOld.selectContractors(driver),
					"All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_ContractorInsuranceCostAnalysisOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_ContractorInsuranceCostAnalysisOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ContractorInsuranceCostAnalysisOld.reportHeaderReportName(driver).getText(),
					"Contractor Insurance Cost Analysis");
