...
public class Report_ProjectFinancialAnalysisWorkClass_Old_Test extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Project Financial Analysis Work Class";

	@Test(dataProvider = "excelData")
	public void testProjectFinancialAnalysisWorkClasstOld(String ProgramName, String Division, String Projects,
		...
		try {
			...
			wb.selectSingleValueByIndex(Report_ProjectSummaryReportOld.selectProjects(driver), 1);
		...
		try {
			...
			System.out.println(Report_ProjectSummaryReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ProjectSummaryReportOld.reportHeaderReportName(driver).getText(),
					"Project Financial Analysis WorkClass Report");
