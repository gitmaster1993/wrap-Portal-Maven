...
public class Report_ProjectSummaryReportOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Project Summary Report";
	...
	public void testProjectSummaryReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			wb.selectSingleValue(Report_ProjectSummaryReportOld.selectDivision(driver), Division);
