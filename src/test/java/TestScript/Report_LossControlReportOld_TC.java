...
import ObjectRepository.Report_LossControlReportOld;

public class Report_LossControlReportOld_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Loss Control Report";

	@Test(dataProvider = "excelData")
	public void testLossControlReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_LossControlReportOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			/*
			 * wb.selectSingleValue(Report_LossControlReportOld.selectDivision(
			 * driver), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */
			wb.selectSingleValueByIndex(Report_LossControlReportOld.selectProjects(driver), 1);

			// wb.selectSingleValue(Report_LossControlReportOld.selectProjects(driver),
			// Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);

			wb.selectSingleValue(Report_LossControlReportOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);

			Report_LossControlReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_LossControlReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_LossControlReportOld.reportHeaderReportName(driver).getText(),
					"Loss Control Report");
