...
import ObjectRepository.Report_ProjectCloseOutReportOld;

public class Report_ProjectCloseOutReportOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Project Close Out Report";

	@Test(dataProvider = "excelData")
	public void testProjectCloseOutReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ProjectCloseOutReportOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			wb.selectSingleValue(Report_ProjectCloseOutReportOld.selectDivision(driver), Division);
			test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ProjectCloseOutReportOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);

			Report_ProjectCloseOutReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_ProjectCloseOutReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ProjectCloseOutReportOld.reportHeaderReportName(driver).getText(),
