...
public class Report_ProgramDeductionRateAnalysisOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Program Deduction Rate Analysis";

	@Test(dataProvider = "excelData")
	public void testProgramDeductionRateAnalysisOld(String ProgramName, String Division, String Projects,
		...
		try {
			...
			// wb.selectSingleValue(Report_ProgramDeductionRateAnalysisOld.selectDivision(driver),
			// Division);
			// test.log(LogStatus.PASS, " Divisions Selected Successfully");
			// Thread.sleep(3000);
			wb.selectSingleValue(Report_ProgramDeductionRateAnalysisOld.selectProjects(driver), Projects);
