...
import ObjectRepository.Report_NonCIPStatusReportOld;

public class Report_NonCIPStatusReportOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Non CIP Status Report";

	@Test(dataProvider = "excelData")
	public void testNonCIPStatusReportOld(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2)
		...
		try {
			...
			Thread.sleep(5000);
			Report_NonCIPStatusReportOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			wb.selectSingleValue(Report_NonCIPStatusReportOld.selectDivision(driver), Division);
			test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_NonCIPStatusReportOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_NonCIPStatusReportOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_NonCIPStatusReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_NonCIPStatusReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_NonCIPStatusReportOld.reportHeaderReportName(driver).getText(),
					"Non CIP Status Report");
