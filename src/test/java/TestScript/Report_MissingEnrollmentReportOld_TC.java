...
import ObjectRepository.Report_MissingEnrollmentReportOld;

public class Report_MissingEnrollmentReportOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Missing Enrollment Report";

	@Test(dataProvider = "excelData")
	public void testMissingEnrollmentReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_MissingEnrollmentReportOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			wb.selectSingleValue(Report_MissingEnrollmentReportOld.selectDivision(driver), Division);
			test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_MissingEnrollmentReportOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_MissingEnrollmentReportOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_MissingEnrollmentReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_MissingEnrollmentReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_MissingEnrollmentReportOld.reportHeaderReportName(driver).getText(),
