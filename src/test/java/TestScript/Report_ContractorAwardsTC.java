...
public class Report_ContractorAwardsTC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Contractor Awards Report"; // Raja
//	String project1 = "120 Piedmont Student Housing";
//	String project2 = "712 West Peachtree";

	@Test(dataProvider = "excelData")
	public void testContractorAwards(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			// Raja
			/*
			 * wb.selectSingleValue(Report_ContractorAwards.filterSelectDivisionDropdown(
			...
			js.executeScript("arguments[0].scrollIntoView();",
					Report_ContractorAwards.filterSelectProjectFormOption(driver, Projects));
