...
import ObjectRepository.Report_ContractorRosterReportOld;
import ObjectRepository.Report_EnrollmentListReportOld;

public class Report_ContractorRosterReportOld_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Contractor Roster Report";

	@Test(dataProvider = "excelData")
	public void testContractorRosterReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ContractorRosterReportOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			//wb.selectSingleValue(Report_ContractorRosterReportOld.selectDivision(driver), "All Divisions");
			test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ContractorRosterReportOld.selectProjects(driver), "All Projects");
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ContractorRosterReportOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_ContractorRosterReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_ContractorRosterReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ContractorRosterReportOld.reportHeaderReportName(driver).getText(),
