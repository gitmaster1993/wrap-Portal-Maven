...
import ObjectRepository.Report_CertificateTrackingReportOld;
import ObjectRepository.Report_EnrollmentListReportOld;

public class Report_CertificateTrackingReportOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Certificate Tracking Report";

	@Test(dataProvider = "excelData")
	public void testCertificateTrackingReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_CertificateTrackingReportOld.selectReport(driver, selectReportName).click();
			...
			/*
			 * wb.selectSingleValue(Report_CertificateTrackingReportOld.
			 * selectDivision(driver), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */
			wb.selectSingleValue(Report_CertificateTrackingReportOld.selectProjects(driver), Projects);

			// wb.selectSingleValueByIndex(Report_CertificateTrackingReportOld.selectProjects(driver),
			// 0);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);

			Report_CertificateTrackingReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_CertificateTrackingReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_CertificateTrackingReportOld.reportHeaderReportName(driver).getText(),
