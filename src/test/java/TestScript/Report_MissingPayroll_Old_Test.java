...
public class Report_MissingPayroll_Old_Test extends BaseClass
{
	...
	public void testMissingPayrollOld(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2)
		...
		try {
			...
			/*wb.selectSingleValue(Report_ContractorCostSummaryOld.selectDivision(driver), Division);
			test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);*/
			
			wb.selectSingleValueByIndex(Report_ContractorCostSummaryOld.selectProjects(driver), 1);
				
//			wb.selectSingleValue(Report_ContractorCostSummaryOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(5000);
			
			wb.selectSingleValueByIndex(Report_ContractorCostSummaryOld.selectContractors(driver), 2);
