...
public class Report_PayrollAuditSummaryByWorkClassOld_Test extends BaseClass
{
	...
	public void testPayrollAuditSummaryOld(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2)
		...
		/*	wb.selectSingleValue(Report_PayrollAuditSummaryOld.selectDivision(driver), Division);
			...
			Thread.sleep(3000);
*/
			wb.selectSingleValueByIndex(Report_PayrollAuditSummaryOld.selectProjects(driver), 1);
...
//			wb.selectSingleValue(Report_PayrollAuditSummaryOld.selectProjects(driver), Projects);
		...
		try {
			...
			if (Report_PayrollAuditSummaryOld.reportHeaderReportName(driver).getText()
					.contains("Payroll Audit Summary By Work Class")) {
