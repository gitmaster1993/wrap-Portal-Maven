...
import ObjectRepository.Report_ContractorProfileOld;
import ObjectRepository.Report_EnrollmentListReportOld;

public class Report_ContractorProfileOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Contractor Profile";

	@Test(dataProvider = "excelData")
	public void testContractorProfile(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ContractorProfileOld.selectReport(driver, selectReportName).click();
			...
			/*
			 * wb.selectSingleValue(Report_ContractorProfileOld.selectDivision(
			 * driver), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */

			// wb.selectSingleValueByIndex(Report_ContractorProfileOld.selectProjects(driver),
			// 1);

			wb.selectSingleValue(Report_ContractorProfileOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ContractorProfileOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_ContractorProfileOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_ContractorProfileOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ContractorProfileOld.reportHeaderReportName(driver).getText(),
					"Contractor Profile");
