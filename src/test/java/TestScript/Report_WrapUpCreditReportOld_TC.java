...
import ObjectRepository.Report_WrapUpCreditReportOld;

public class Report_WrapUpCreditReportOld_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Wrap Up Credit Report";

	@Test(dataProvider = "excelData")
	public void testWrapUpCreditReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_WrapUpCreditReportOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			wb.selectSingleValue(Report_WrapUpCreditReportOld.selectDivision(driver), Division);
			test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_WrapUpCreditReportOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_WrapUpCreditReportOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_WrapUpCreditReportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_WrapUpCreditReportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_WrapUpCreditReportOld.reportHeaderReportName(driver).getText(),
