...
public class Report_LaborRateAnalysisOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Labor Rate Analysis";

	@Test(dataProvider = "excelData")
	public void testLaborRateAnalysisOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			/*
			 * wb.selectSingleValue(Report_LaborRateAnalysisOld.selectDivision(
			 * driver),Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */

			// wb.selectSingleValueByIndex(Report_LaborRateAnalysisOld.selectProjects(driver),
			// 1);
