...
public class Report_ContractorPayrollManHoursAndLaborRateOld_Keenan extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Contractor Payroll, Man-Hours & Labor Rate";// "Contractor
																			// Payroll,
																			// Man-Hours
																			// &
																			// Labor
	...
	public void testContractorPayrollManHoursAndLaborRateOld(String ProgramName, String Division, String Projects,
		...
		try {
			 ...
			 * Report_ContractorPayrollManHoursAndLaborRateOld.selectDivision(
			 * driver), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */

			wb.selectSingleValueByIndex(Report_ContractorPayrollManHoursAndLaborRateOld.selectProjects(driver), 1);

			// wb.selectSingleValue(Report_ContractorPayrollManHoursAndLaborRateOld.selectProjects(driver),
			// Projects);
		...
		try {
			...
			Assert.assertEquals(
					...
					"Contractor Payroll, Man-Hours & Labor Rate");// "Contractor
																	// Payroll,
																	// Man-Hours
																	// & Labor
																	// Rate"
