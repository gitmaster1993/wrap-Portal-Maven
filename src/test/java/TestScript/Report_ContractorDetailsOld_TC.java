...
import ObjectRepository.Report_ContractorDetailsOld;
import ObjectRepository.Report_EnrollmentListReportOld;

public class Report_ContractorDetailsOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Contractor Details";

	@Test(dataProvider = "excelData")
	public void testContractorDetailsOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ContractorDetailsOld.selectReport(driver, selectReportName).click();
			...
			/*
			 * wb.selectSingleValue(Report_ContractorDetailsOld.selectDivision(
			 * driver), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */

			// wb.selectSingleValueByIndex(Report_ContractorDetailsOld.selectProjects(driver),
			// 1);
			wb.selectSingleValue(Report_ContractorDetailsOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);

			wb.selectSingleValue(Report_ContractorDetailsOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_ContractorDetailsOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_ContractorDetailsOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ContractorDetailsOld.reportHeaderReportName(driver).getText(),
					"Contractor Details");
