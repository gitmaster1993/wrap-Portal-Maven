...
public class Report_EnrollmentStatusReport_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Enrollment Status Report";
//	String ProjectNAME1 ="UC - Test ";
//	String ProjectNAME2 ="UCD Tercero Dining Commons 2";

	@Test(dataProvider = "excelData")
	public void testEnrollmentStatusReport(String ProgramName, String Division, String Projects,String userName, String password, String ProjectNAME1,String ProjectNAME2)
			throws Throwable {
//		WPO_LoginActionClientWise.logInWTW(driver);
		try {
			...
			Thread.sleep(5000);
			Report_EnrollmentStatusReport.selectReport(driver, selectReportName).click();
			...
			js.executeScript("arguments[0].scrollIntoView();",Report_EnrollmentStatusReport.filterSelectDivisionDropdown(driver));
			Report_EnrollmentStatusReport.filterSelectDivisionDropdown(driver).click();
			...
			/*
			 * wb.selectSingleValue(Report_EnrollmentStatusReport.
			...
			js.executeScript("arguments[0].scrollIntoView();", Report_EnrollmentStatusReport.filterSelectContractorFormOption(driver));
			/*
			 * wb.selectSingleValue(Report_EnrollmentStatusReport.
			 * filterSelectContractorFormOption(driver), "All Contractors");
			 */
			Report_EnrollmentStatusReport.filterSelectContractorFormOption(driver).click();
...
//		String filePath="D:\\NOURTEK\\Wrap Portal-2\\testData\\WTWTestData.xlsx";
	...
	public void testCount(int projectSize, int contPkgSize) {
		...
		List<WebElement> countOfProject = Report_EnrollmentStatusReport.countProjectNames(driver);
		List<WebElement> countOfContractorPkg = Report_EnrollmentStatusReport.countProjectWiseContractorPkg(driver);
