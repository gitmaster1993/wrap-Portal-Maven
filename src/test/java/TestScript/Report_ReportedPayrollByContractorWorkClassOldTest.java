...
import ObjectRepository.Report_ReportedPayrollByContractorOld;

public class Report_ReportedPayrollByContractorWorkClassOldTest extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Reported Payroll By Contractor Work Class";

	@Test(dataProvider = "excelData")
	public void testReportedPayrollByContractorOld(String ProgramName, String Division, String Projects,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ReportedPayrollByContractorOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			wb.selectSingleValue(Report_ReportedPayrollByContractorOld.selectDivision(driver), Division);
			test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ReportedPayrollByContractorOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ReportedPayrollByContractorOld.selectContractors(driver), "All Contractors");
		...
		try {
			...
			System.out.println(Report_ReportedPayrollByContractorOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ReportedPayrollByContractorOld.reportHeaderReportName(driver).getText(),
					"Reported Payroll By Contractor");
