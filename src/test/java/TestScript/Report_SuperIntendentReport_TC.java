...
import ObjectRepository.Report_SuperIntendentReport;

public class Report_SuperIntendentReport_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Superintendent Report";
//	String ProjectNAME1 ="UC - Test ";
//	String ProjectNAME2 ="UCD Tercero Dining Commons 2";

	@Test(dataProvider = "excelData")
	public void testSuperIntendentReport(String ProgramName, String Division, String Projects,String userName, String password, String ProjectNAME1,String ProjectNAME2)
...
//			WPO_LoginActionClientWise.logInWTW(driver);
			...
			Thread.sleep(5000);
			Report_SuperIntendentReport.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));

			wb.selectSingleValue(Report_SuperIntendentReport.filterSelectDivisionDropdown(driver), Division);
			test.log(LogStatus.PASS, Division + " Divisions Selected Successfully");
			
			//Raja commneted it as by default it is taking All project
			
			/*
			 * wb.selectSingleValue(Report_SuperIntendentReport.
			...
			//wb.selectSingleValue(Report_SuperIntendentReport.filterSelectContractorFormOption(driver),
			//		"All Contractors");
			JavascriptExecutor js = (JavascriptExecutor)driver;
			js.executeScript("arguments[0].scrollIntoView();", Report_SuperIntendentReport.filterSelectContractorFormOption(driver));
			Report_SuperIntendentReport.filterSelectContractorFormOption(driver).click();
			test.log(LogStatus.PASS, " Contractor Selected Successfully");

			Report_SuperIntendentReport.btnBuildReport(driver).click();
		...
		try {
			System.out.println(Report_SuperIntendentReport.reportHeaderReportName(driver).getText());

			SoftAssert softAssertion = new SoftAssert();
			System.out.println(Report_SuperIntendentReport.reportHeaderReportName(driver).getText());
			softAssertion.assertEquals(Report_SuperIntendentReport.reportHeaderReportName(driver).getText(),
					"Superintendent Report");
			System.out.println("Report Name is Matched");
			test.log(LogStatus.PASS, "Report Header Name Matched");
			test.log(LogStatus.PASS, "Report Generated Successfully");
			softAssertion.assertEquals(Report_SuperIntendentReport.programName(driver).getText(), ProgramName);
			test.log(LogStatus.PASS, "Program Name:- " + Report_SuperIntendentReport.programName(driver).getText());
			test.log(LogStatus.PASS, "Sponsor Name:- " + Report_SuperIntendentReport.sponsorName(driver).getText());
			// test.log(LogStatus.PASS,"Project Name:- " +
			// Report_SuperIntendentReport.projectName(driver).getText());

			test.log(LogStatus.PASS, "Time Stamp:- " + Report_SuperIntendentReport.timeStamp(driver).getText());
			test.log(LogStatus.PASS,
					"PDF Option is Present:- " + Report_SuperIntendentReport.exportToPDF(driver).isDisplayed());
			test.log(LogStatus.PASS,
					"Excel Option is Present:- " + Report_SuperIntendentReport.exportToExcel(driver).isDisplayed());
			test.log(LogStatus.PASS, "================= Column Name =================");
			List<WebElement> list = Report_SuperIntendentReport.allColumnName(driver);
			// wb.printListData();
		...
		Thread.sleep(1000);
		js.executeScript("arguments[0].click();", Report_SuperIntendentReport.btnBuildReport(driver));
		test.log(LogStatus.INFO, " Clicked On Build Report Button");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		js.executeScript("arguments[0].click();",
				ReportModule.filterSelectProjectFormOption(driver, ProjectNAME2));
		...
		Report_SuperIntendentReport.pdfLink(driver).click();
		Thread.sleep(5000);
		wb.getWindowID3();
		// Thread.sleep(1500);
		...
		// Excel file
		Report_SuperIntendentReport.excelLink(driver).click();
		Thread.sleep(10000);
		if (wb.isFileDownloaded("Superintendent_Report.xls") == true) {
...
//		String filePath="D:\\NOURTEK\\Wrap Portal-2\\testData\\WTWTestData.xlsx";
	...
	public void testCount(int projectSize, int contPkgSize) {
		...
		List<WebElement> countOfProject = Report_SuperIntendentReport.countProjectNames(driver);
		List<WebElement> countOfContractorPkg = Report_SuperIntendentReport.countProjectWiseContractorPkg(driver);
