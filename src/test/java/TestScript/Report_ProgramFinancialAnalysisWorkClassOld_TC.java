...
import ObjectRepository.Report_ProgramFinancialAnalysisWorkClassOld;

public class Report_ProgramFinancialAnalysisWorkClassOld_TC extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Program Financial Analysis Work Class";

	@Test(dataProvider = "excelData")
	public void testProgramFinancialAnalysisWorkClassOld(String ProgramName, String Division, String Projects,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ProgramFinancialAnalysisWorkClassOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			// wb.selectSingleValue(Report_ProgramFinancialAnalysisWorkClassOld.selectDivision(driver),
			// Division);
			// test.log(LogStatus.PASS, " Divisions Selected Successfully");
			// Thread.sleep(3000);
			wb.selectSingleValue(Report_ProgramFinancialAnalysisWorkClassOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ProgramFinancialAnalysisWorkClassOld.selectContractors(driver),
					"All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_ProgramFinancialAnalysisWorkClassOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_ProgramFinancialAnalysisWorkClassOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ProgramFinancialAnalysisWorkClassOld.reportHeaderReportName(driver).getText(),
					"Program Financial Analysis WorkClass Report");
