...
import ObjectRepository.Report_ProjectInsuranceCostAnalysisOld;

public class Report_ProjectInsuranceCostAnalysisOld_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Project Insurance Cost Analysis ";

	@Test(dataProvider = "excelData")
	public void testProjectInsuranceCostAnalysisOld(String ProgramName, String Division, String Projects,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ProjectInsuranceCostAnalysisOld.selectReport(driver, selectReportName).click();
			test.log(LogStatus.PASS, selectReportName + " Report is Selected");
			wb.getWindowIDs();
			driver.switchTo().window(wb.map.get("childID"));
			driver.switchTo().frame(0);
			wb.selectSingleValue(Report_ProjectInsuranceCostAnalysisOld.selectDivision(driver), Division);
			test.log(LogStatus.PASS, " Divisions Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ProjectInsuranceCostAnalysisOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);
			wb.selectSingleValue(Report_ProjectInsuranceCostAnalysisOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_ProjectInsuranceCostAnalysisOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_ProjectInsuranceCostAnalysisOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_ProjectInsuranceCostAnalysisOld.reportHeaderReportName(driver).getText(),
