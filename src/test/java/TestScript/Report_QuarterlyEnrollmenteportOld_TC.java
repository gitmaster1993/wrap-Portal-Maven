...
import ObjectRepository.Report_QuarterlyEnrollmenteportOld;

public class Report_QuarterlyEnrollmenteportOld_TC extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Quarterly Enrollment Report";

	@Test(dataProvider = "excelData")
	public void testQuarterlyEnrollmenteportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_QuarterlyEnrollmenteportOld.selectReport(driver, selectReportName).click();
			...
			/*
			 * wb.selectSingleValue(Report_QuarterlyEnrollmenteportOld.
			 * selectDivision(driver), Division); test.log(LogStatus.PASS,
			 * " Divisions Selected Successfully"); Thread.sleep(3000);
			 */

			// wb.selectSingleValueByIndex(Report_QuarterlyEnrollmenteportOld.selectProjects(driver),
			// 1);

			wb.selectSingleValue(Report_QuarterlyEnrollmenteportOld.selectProjects(driver), Projects);
			test.log(LogStatus.PASS, " Project Selected Successfully");
			Thread.sleep(3000);

			wb.selectSingleValue(Report_QuarterlyEnrollmenteportOld.selectContractors(driver), "All Contractors");
			test.log(LogStatus.PASS, " Contractor Selected Successfully");
			Thread.sleep(3000);
			Report_QuarterlyEnrollmenteportOld.btnBuildReport(driver).click();
		...
		try {
			...
			System.out.println(Report_QuarterlyEnrollmenteportOld.reportHeaderReportName(driver).getText());
			Assert.assertEquals(Report_QuarterlyEnrollmenteportOld.reportHeaderReportName(driver).getText(),
		 ...
		 * Thread.sleep(7000); test.log(LogStatus.PASS, "Pdf Generated " +
