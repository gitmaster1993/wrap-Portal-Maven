...
public class Report_ContractorCloseOutTrackingOld 
{
	...
	static String reportHeaderReportName= "//span[@id='LblHeading']";
	
	//Raja 
	static String reportHeaderReportName_Deduct ="//span[@id ='Label1' and @class='ReportPageHeader']";
	
	public static WebElement reportHeaderReportName_Deduct(WebDriver driver) {
		element = driver.findElement(By.xpath(reportHeaderReportName_Deduct));
		return element;
	}
