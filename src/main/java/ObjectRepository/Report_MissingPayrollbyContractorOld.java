...
public class Report_MissingPayrollbyContractorOld 
{
	...
	static String countAllMissingPayroll ="//*[contains(text(),'Sony Tower Test')]/../..//*[contains(text(),'Sony 1 Contractor Company')]/..//following-sibling::tr/td[6]";
	
	public static List<WebElement> countAllMissingPayroll(WebDriver driver) {
		listElement = driver.findElements(By.xpath(countAllMissingPayroll));
		return listElement;
	}
