...
public class Report_EnrolledContractorsList 
{
	...
	static String countContractorPkg ="//div[@id='divTableData']//table/tbody/tr/td[contains(text(),'Total Awards on Project:')]/../td[2]";
	...
	static String addFilterParameter1 ="//input[@id='s2id_autogen1']";                  //"//input[@id='txtParam1']"; //div[@id='s2id_lbParam']";
