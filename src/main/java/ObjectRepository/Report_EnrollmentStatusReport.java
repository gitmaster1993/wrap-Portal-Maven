...
public class Report_EnrollmentStatusReport 
{
	...
	//Raja 
	static String filterSelectDivisionDropdown= "//div[@id='ctrlBuildReport_divDivision']//div/select/option[1]";                  //"//select[@id='lstDivisons']"; //Raja  //"//select[@id='ctrlBuildReport_lbDivision']"
	...
	//Raja 
	static String filterSelectContractorFormOption="//div[@id='ctrlBuildReport_divContractor']//div/select/option[1]";                  //"//select[@id='ctrlBuildReport_lbWorkSite']"; //Raja //select[@id='ctrlBuildReport_lbContractor']";
	
	//Raja 
	static String reportHeaderReportName="//td[@class='mainTitle tcc']";           // "//td[@class='mainTitle txt-center']";
//			"//b[contains(text(),'Contractor Enrollment Summary')]";
	...
	public static WebElement filterSelectProjectFormOption(WebDriver driver) {
		element = driver.findElement(By.xpath("//select[@id='ctrlBuildReport_lbWorkSite']")); //select[@id='ListBox2']")); //Raja//select[@id='ctrlBuildReport_lbWorkSite']"))
		return element;
	...
	//Raja 
	static String timeStamp= "//td[@class='dateTimeHeader trt']";      //"//td[@class='dateTimeHeader txt-right']";//span[@id='spnHeaderContent']//table/thead/tr[1]";
	...
	static String pdfLink ="//a[@id='lnkPDF']"; //tr[@id='trExportLinks']//td/a[@id='HlinkExportPDF']"; //Raja //div[@id='divExportIcon']/ul//li[@id='liPDF']"; 
	static String excelLink ="//a[@id='lnkExcel']"; //tr[@id='trExportLinks']//td/a[@id='HlinkExportExcel']";//Raja //div[@id='divExportIcon']/ul//li[@id='liExcel']";
