...
public class Report_SuperIntendentReport {
  ...
  //Raja
	static String SelectDivisionFromList ="//div[@id='ctrlBuildReport_divDivision']/div//select[@name='ctrlBuildReport$lbDivision']/option";
	
	
	public static List<WebElement> SelectDivisionFromList(WebDriver driver) {
		listElement = driver.findElements(By.xpath(SelectDivisionFromList));
		return listElement;
	}
	
	static String SelectProjectFromList ="//div[@id='ctrlBuildReport_divWorksite']/div//select[@name='ctrlBuildReport$lbWorkSite']/option";
...
//			"//b[contains(text(),'Contractor Enrollment Summary')]";
	...
	static String timeStamp="//td[@class='dateTimeHeader txt-right']"; //td[@class='dateTimeHeader txt-right']
	...
	static String countProjectWiseContractorPkg="//div[@id='divTableDataWeb']//tbody//tr//td[@class='innerTableData tdContractor']";
