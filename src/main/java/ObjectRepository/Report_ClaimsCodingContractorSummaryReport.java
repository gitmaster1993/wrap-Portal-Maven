...
public class Report_ClaimsCodingContractorSummaryReport 
{
	...
	static String pdfLink ="//a[@id='lnkPDF']"; //div[@id='divExportIcon']/ul/li[1]// raja changed it 
	static String excelLink ="//a[@id='lnkExcel']"; //div[@id='divExportIcon']/ul/li[2]//Raja changed it 
