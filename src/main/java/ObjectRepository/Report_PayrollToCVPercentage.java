...
public class Report_PayrollToCVPercentage {
	...
	static String countContractorPkg = "//div[@id='divTableData']//table/tbody/tr[position()>2]/td[contains(@class,'bRight bBottom aCenter wLSpacing default') and position()=3]";
