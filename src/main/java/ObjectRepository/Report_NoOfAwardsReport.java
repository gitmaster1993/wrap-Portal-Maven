...
public class Report_NoOfAwardsReport 
{
...
//			"//b[contains(text(),'Contractor Enrollment Summary')]";
	...
	static String selectFromDate ="//input[@id='ctrlBuildReport_txtFromDate']";
	static String selectToDate ="//input[@id='ctrlBuildReport_txtToDate']";
