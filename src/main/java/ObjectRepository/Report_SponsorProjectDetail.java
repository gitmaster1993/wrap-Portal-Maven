...
public class Report_SponsorProjectDetail 
{
	...
	static String reportHeaderReportName= "//td[normalize-space()='Sponsor Program Detail']";    //"//div[@id='divHeaderTable']//tr[1]";	
	...
	//for filter 
		...
		static String countContractorPkg ="//div[@id='divTableData']//table/tbody/tr[position()>2]/td[4]";
