...
public class Report_ContractorDeductSummary {
	...
	static String reportHeaderReportName = "//td[normalize-space()='Contractor Deduct Summary']";
	...
	static String countContractorPkg ="//div[@id='divTableData']//table/tbody/tr[position()>2 and position()<last()-1]//td[@align='left' and position()=1]";
