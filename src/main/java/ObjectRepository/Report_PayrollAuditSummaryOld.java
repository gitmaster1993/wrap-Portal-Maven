...
public class Report_PayrollAuditSummaryOld 
{
	...
	static String reportHeaderReportName= "//body/table/tbody/tr[4]/td[1]";
	...
	static String frameReprot ="//iframe[@name='Report']";
	
	public static WebElement frameReprot(WebDriver driver) {
		element = driver.findElement(By.xpath(frameReprot));
		return element;
		//we directly fetch project name in method and use dynamic xpath to accepting report name through method
	}
