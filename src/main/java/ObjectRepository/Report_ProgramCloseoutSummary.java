...
public class Report_ProgramCloseoutSummary
{
	...
	static String reportHeaderReportName = "//div[@id='divHeaderTable']//tr[2]";
	...
	//for filter 
			...
			static String countContractorPkg ="//div[@id='divTableData']//table/tbody/tr[position()>2]/td[contains(@align,'left') and position()=1]";
