...
public class Report_ContractorAwards {
	...
	//for filter 
		...
		static String countContractorPkg ="//div[@id='divTableData']//table/tbody/tr[position()>2]/td[@class='bBottom aLeft wLSpacing default ' and position()=3]";
