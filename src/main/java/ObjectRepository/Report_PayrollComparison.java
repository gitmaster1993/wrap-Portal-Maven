...
public class Report_PayrollComparison {
	...
	//for filter 
		...
		static String countContractorPkg ="//div[@id='divTableData']//table/tbody/tr[position()>2]/td[contains(@style,'left') and position()=3]";
