...
public class Report_EnrollmentReport 
{
	...
	//Raja
	static String reportHeaderReportName= "//td[normalize-space()='Enrollment Report']"; //div[@id='divHeaderTable']//tr[1]";	
...
//		element = driver.findElement(By.xpath("//span[contains(text(),'"+reportName+"')]"));
		element = driver.findElement(By.xpath("//span[text()='"+reportName+"']"));
		return element;
	...
	static String countContractorPkg ="//div[@id='divTableData']//table/tbody/tr[position()>2]//td[contains(@style,'border-left') and position()=2]";
