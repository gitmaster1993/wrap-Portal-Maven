...
public class Report_NCP_Contract_Status_Report 
{
...
//			"//b[contains(text(),'Contractor Enrollment Summary')]";
	...
	static String grandTotalOfContractor="//table[@class='mainTable']/tbody/tr[last()-4]//table[@class='innerTable tbl-alt tableData']//tr[@class='total-heading']//following::tr[1]/td[2]";
