...
public class Report_NCP_Missing_Payroll_Report 
{
	...
	static String filterSelectProjectFormOption = "//div[@id='ctrlBuildReport_divWorksite']//select//option[contains(text(),'All Worksites')]";
	...
	public static WebElement filterSelectProjectFormOption(WebDriver driver, String projectName) {
		element = driver.findElement(By.xpath("//div[@id='ctrlBuildReport_divWorksite']//select//option[contains(text(),'"+ projectName +"')]"));
		return element;
