...
public class Report_NCP_Submitted_Payroll_Report 
{
...
//			"//b[contains(text(),'Contractor Enrollment Summary')]";
	static String filterSelectFromMonth="//select[@id='ctrlBuildReport_ddlFromMonthYear']";
	static String filterSelectToMonth="//select[@id='ctrlBuildReport_ddlToMonthYear']";
	...
	public static WebElement filterSelectFromMonth(WebDriver driver) {
		element = driver.findElement(By.xpath(filterSelectFromMonth));
		return element;
	}
	public static WebElement filterSelectToMonth(WebDriver driver) {
		element = driver.findElement(By.xpath(filterSelectToMonth));
		return element;
	}
	...
	static String projectName="//table[@class='mainTable']/tbody/tr[2]//table[@class='subTable-child']/tbody/tr[1]//table[@class='innerTable']/tbody/tr[1]/td[2]/span";
	static String allProjectName="//*[@class='innerTable']/tbody/tr/td[1]/span";//list
	static String allColumnName="//table[@class='mainTable']/tbody/tr[2]//table[@class='subTable-child']/tbody/tr[4]/td/table/tbody/tr[1]/th";//list
	...
	static String countProjectWiseContractorPkg="//div[@id='divTableData']//table[@class='mainTable']/tbody/tr//table[@class='innerTable']//tbody/tr/td[contains(text(),'Contract #:')]";
