...
public class Report_NCP_Final_Deduct 
{
	...
	static String reportHeaderReportName= "//div[@id='divTableData']//tr[1]//td[1]";
//			"//b[contains(text(),'Contractor Enrollment Summary')]";
	...
	static String AllDataFinalDeduct ="//div[@id='divExport']//table//tbody//tr//td[starts-with(@style,'text-align:')]";
	
	
	public static List<WebElement> AllDataFinalDeduct(WebDriver driver) 
	{
		listElement = driver.findElements(By.xpath(AllDataFinalDeduct));
		return listElement;
	}
